  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="p-6 bg-gradient-to-r from-purple-500 to-purple-600 text-white text-center">
        ...
        <p className="text-white/90 text-sm mt-1">{user?.email || 'user@example.com'}</p>
      </Card>
      ...
      <Card className="p-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-gray-900">{user?.employeeId || 'BKK001'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600">แผนก</span>
            <span className="font-medium text-gray-900">{user?.department || 'IT'}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-gray-600">ตำแหน่ง</span>
            <span className="font-medium text-gray-900">{user?.position || 'Developer'}</span>
          </div>
          <div className="flex items-center justify-between">
      ...
      <Card className="p-4">
        ...
        {isEditing && (
          <Button onClick={handleSave} className="w-full mt-4 bg-purple-500 hover:bg-purple-600">
            บันทึกข้อมูล
          </Button>
        )}
      </Card>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
                ...
                <div key={field}>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2 pr-10 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:outline-none"
            ...
            <div className="flex gap-2 mt-5">
              ...
              <Button className="flex-1 bg-purple-500 hover:bg-purple-600" onClick={handleChangePassword} disabled={isSubmitting}>
